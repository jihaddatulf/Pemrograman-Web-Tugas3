...
<head>
  <title>Jihaddatulf Website</title>
  <meta charset="utf-8">
...
<div class="container-lg">
        <div class="pt-3 row justify-content-center my-3">
            <h1>ComboBox</h1>
            <p class="hint-text">Silahkan mengisi data di bawah ini. Mohon mengisi data dengan teliti dan benar ! </p>
        </div>
</div> 
  <div class="container">
    <br>
  ...
  <!-- Footer -->
  <footer id="footer">
    <div class="container-fluid back-to-top d-flex align-items-center justify-content-center bg-light p-5 my-3">
      <div class="copyright">
        &copy; 2022 Copyright <strong><span>Jihaddatulf</span></strong>. All Rights Reserved
      </div>
    <!-- End Footer -->
</body>
